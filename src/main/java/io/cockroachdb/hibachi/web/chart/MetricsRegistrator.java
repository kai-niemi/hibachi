...
//        Gauge.builder("hibachi.pool.connections.usage", metadata, HikariDataSourcePoolMetadata::getUsage)
...
//                .register(meterRegistry);
        ...
        return new TimeSeries(meterRegistry, List.of(
//                meterRegistry.find("hibachi.pool.connections.usage").tag("name", dataSource.getPoolName()),
